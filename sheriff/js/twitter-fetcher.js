...
function dateFormatter(date) {
    ...
    var tweetTime = date.getHours();
    tweetTime = tweetTime -5;
    var nowTime = new Date();
    var nowHour = nowTime.getHours();
    var agoTime = nowHour - tweetTime;
    
    if (agoTime > 24) {
        var tweetMonth = date.getMonth();
        var months = ["Jan","Feb","Mar","Apr","May","Jun","July","Aug","Sep","Oct","Nov","Dec"];
        var tweetDate = months[tweetMonth];
        agoTime = tweetDate + ' '+ date.getDate();        
    } else {
        agoTime = agoTime +'h';
    }
