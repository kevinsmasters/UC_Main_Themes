...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <meta property="og:image" content="http://ulstercountyny.gov/sites/default/files/seal-two.png" />
  <?php print $styles; ?>
  <?php print $scripts; ?>
  <?php if ($add_respond_js): ?>
    <!--[if lt IE 9]>
    <script src="<?php print $base_path . $path_to_zen; ?>/js/html5-respond.js"></script>
    <link href="/sites/all/themes/ulster_county/css/ie8.css" rel="stylesheet" type="text/css" />
    <![endif]-->
  <?php elseif ($add_html5_shim): ?>
    ...
    <![endif]-->
  <?php endif; ?>
  <script src="/sites/all/themes/ulster_county/js/modernizr.custom.70339.js"></script>
  ...
  <script>
  var pagePath = "<?php print drupal_get_path_alias(current_path()); ?>";	
  //alert (pagePath);
  ...
  if (pagePath.includes("ulsterforbusiness")) { 
  
  
  
  if (pagePath.includes("thank")) { 
  //console.log('thank');
...
window._fbq.push(['track', '6030172420464', {'value':'0.00','currency':'USD'}]);
...
_fbq.push(['addPixelId', '1425297914400241']);
})();
window._fbq = window._fbq || [];
window._fbq.push(['track', 'PixelInitialized', {}]);

} //end if includes thank

} //end if ulsterforbusiness
</script>

<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?id=994078593959289&amp;ev=PixelInitialized" /></noscript>
<script>
    jQuery(document).ready(function() {         
        
        jQuery('.action-links a').each(function() {
        var text = jQuery(this).text();
        jQuery(this).text(text.replace('Clone content', 'Create duplicate')); 
    });
    });
