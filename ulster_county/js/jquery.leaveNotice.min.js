	...
	jQuery.fn.leaveNotice = function(opt){
		...
		return this.each(function(){
			...
			el.click(function(){
				...
				msgContent=preFilteredContent.replace(/\{URL\}/g, '<a href="'+url+'" title="'+url+'"'+options.linkString+' target="_blank">'+linkText+'</a>');
				...
				if (options.timeOut>0) {
					...
					msgContent+='<p id="ln-cancelMessage"><a href="'+url+'" title="'+url+'"'+options.linkString+' target="_blank" id="ln_contLink">Continue</a> or <a href="#close" id="ln-cancelLink">Cancel</a></p>';
				}
				...
				jQuery('#ln_contLink').click(function(){
					closeDialog(options, leaveIn);
				});
